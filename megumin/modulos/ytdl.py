    ...
    if "vid" in data:
        try:
            await c.send_video(
                ...
                width=1920,
                height=1080,
                caption=(await tld(m.chat.id, "YOUTUBE_CAPTION")).format(ttemp + yt["title"], url, datetime.timedelta(seconds=yt["duration"]), yt["channel"], yt["view_count"] or 0, yt["like_count"] or 0),
