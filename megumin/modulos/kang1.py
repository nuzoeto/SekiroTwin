...
async def kang_sticker(c: megux, m: Message):
    ...
    if reply and reply.media:
        if reply.photo:
            ...
            if not reply.sticker.file_name:
                return await prog_msg.edit_text("O sticker não tem nome.")
            ...
            return await prog_msg.edit_text("Por Favor, Me envie um sticker ou uma foto para que eu possa <b>Kangar</b> Isso")
    ...
    try:
        ...
        if packname_found:
            await prog_msg.edit_text("`Usando pacote existente...`")
            await c.send(
                AddStickerToSet(
                    stickerset=InputStickerSetShortName(short_name=packname),
            ...
            await prog_msg.edit_text("`Criando um novo pack...`")
            ...
            try:
                ...
                return await prog_msg.edit_text("Me parece que você nunca interagiu comigo no Privado faça isso primeiro."),
        ...
        kanged_success_msg = ("<b>Sticker kangado com sucesso!</b>")
